...
namespace tes_CSharpe_ResourceText.反射
{
    ...
    class TestReflection_Type
    {
        ...
        private void TypeConstructorInfo()
        {
            ...
            orderType.GetConstructor(
                BindingFlags.Instance | BindingFlags.Public, null,
                new Type[] { }, null).Invoke(new object[] { });

            orderType.GetConstructor(
                BindingFlags.Instance | BindingFlags.Public, null,
                new Type[] { typeof(string) }, null).Invoke(new object[] { "os" });

            orderType.GetConstructor(
                BindingFlags.Instance | BindingFlags.Public, null,
                new Type[] { typeof(int) }, null).Invoke(new object[] { 2 });
